# Blind-Spot Causal Diagram for IEEE TNNLS 

import matplotlib.pyplot as plt
import matplotlib.patches as patches

# Compact layout configuration for IEEE double-column grid compatibility
...
# =====================================================================
# 4. CAUSAL VECTOR ANNOTATIONS - ALIGNED WITH SECTION IV-D EQUATIONS
# =====================================================================
...
# --- MARGINAL SEPARATION CORRECTION (Optimized for Overleaf) ---
# Expand the X and Y bounds to prevent accidental clipping of external textual elements
ax.set_xlim(-2.0, grid_size + 2.0)
ax.set_ylim(-0.9, grid_size + 0.9)
ax.set_aspect('equal')
ax.axis('off')
...
plt.show()
print("Synchronized architectural diagram saved as 'blind_spot_network_diagram.png'.")
